...
• **Analytics at Scale:** Managed multi-region reporting infrastructure (US/CA/AU) processing vendor performance data from Redshift and MySQL  
• **Automation Impact:** Delivered **60+ HC savings** through Python-based web scraping and data analysis automation  
...
### **Assistant Manager** | Tolexo Online | *Jun 2015 - Mar 2017*
• Six Sigma project: Reduced dispatch TAT from 3 days to 28 hours through data-driven process optimization  
• Built PostgreSQL-based reporting system for warehouse operations and inventory management  

### **Senior Executive** | Snapdeal | *Aug 2014 - Jun 2015*
• Optimized logistics network handling 9,000+ daily orders, reducing processing time by 60%  
• Automated KPI reporting using SQL and VBA, eliminating manual report generation  

### **Associate Manager** | Jabong | *Feb 2012 - Aug 2014*
• Streamlined vendor payment processing, reducing TAT from 15 days to 7 days  
• Developed warehouse management dashboards using Microsoft Dynamics NAV integration  
...
### **Education**
**Post Graduate Program in Business Analytics** | Purdue University | *2021-2022*  
**MBA (Operations)** | Sikkim Manipal University | *2014-2017*  
...
• **60+ Headcount Savings:** Automated manual processes across multiple organizations  
• **40% Performance Improvement:** Optimized application frameworks and data processing  
...
**Data Pipeline Architecture:** Designed end-to-end data workflows from ingestion to consumption  
**Cloud-First Approach:** Deep expertise in Azure ecosystem with focus on modern data platforms  
**Business Impact:** Consistent track record of delivering measurable ROI through data solutions  
**Continuous Learning:** Actively pursuing advanced certifications in Databricks, Snowflake, and AWS  
...
✅ **Business Acumen:** Deep understanding of E-commerce and Finance domain requirements  
✅ **Automation Expert:** Consistent track record of eliminating manual processes  
✅ **Modern Stack:** Hands-on experience with cloud-native data architectures  
✅ **Leadership Ready:** Experience managing technical teams and mentoring engineers  
